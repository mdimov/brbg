...
class Interceptor extends \Magento\ConfigurableProduct\Block\Plugin\Product\Media\Gallery implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'afterGetOptionsMediaGalleryDataJson');
        if (!$pluginInfo) {
            return parent::afterGetOptionsMediaGalleryDataJson($subject, $result);
        } else {
            return $this->___callPlugins('afterGetOptionsMediaGalleryDataJson', func_get_args(), $pluginInfo);
        }
    }
