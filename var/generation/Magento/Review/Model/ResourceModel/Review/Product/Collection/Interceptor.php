...
class Interceptor extends \Magento\Review\Model\ResourceModel\Review\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addEntityFilter($entityId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addEntityFilter($entityId);
        } else {
    ...
    public function addReviewSummary()
    {
        ...
        if (!$pluginInfo) {
            return parent::addReviewSummary();
        } else {
            return $this->___callPlugins('addReviewSummary', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getResultingIds()
    {
        ...
        if (!$pluginInfo) {
            return parent::getResultingIds();
        } else {
            return $this->___callPlugins('getResultingIds', func_get_args(), $pluginInfo);
        }
    }
