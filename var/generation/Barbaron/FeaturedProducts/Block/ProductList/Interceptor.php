...
class Interceptor extends \Barbaron\FeaturedProducts\Block\ProductList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductLimit');
        if (!$pluginInfo) {
            return parent::getProductLimit();
        } else {
            return $this->___callPlugins('getProductLimit', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageWidth');
        if (!$pluginInfo) {
            return parent::getImageWidth();
        } else {
            return $this->___callPlugins('getImageWidth', func_get_args(), $pluginInfo);
        }
    }
