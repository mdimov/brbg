<?php
namespace Barbaron\FeaturedProducts\Block\SwatchTab;

/**
 * Interceptor class for @see \Barbaron\FeaturedProducts\Block\SwatchTab
 */
class Interceptor extends \Barbaron\FeaturedProducts\Block\SwatchTab implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwatchAttributes');
        if (!$pluginInfo) {
            return parent::getSwatchAttributes();
        } else {
            return $this->___callPlugins('getSwatchAttributes', func_get_args(), $pluginInfo);
        }
    }
